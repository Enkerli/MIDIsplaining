//
//  MIDIsplainKitExtensionAudioUnit.mm
//  MIDIsplainKitExtension
//
//  Created by Alexandre Enkerli on 2023-12-15.
//

#import "MIDIsplainKitExtensionAudioUnit.h"

#import <AVFoundation/AVFoundation.h>
#import <CoreAudioKit/AUViewController.h>
#import <CoreMIDI/CoreMIDI.h>

#import "MIDIsplainKitExtensionAUProcessHelper.hpp"
#import "MIDIsplainKitExtensionDSPKernel.hpp"


// Define parameter addresses.

@interface MIDIsplainKitExtensionAudioUnit ()
...
@implementation MIDIsplainKitExtensionAudioUnit {
    // C++ members need to be ivars; they would be copied on access if they were properties.
    MIDIsplainKitExtensionDSPKernel _kernel;
...
- (void)setupParameterCallbacks {
    ...
    __block MIDIsplainKitExtensionDSPKernel *kernel = &_kernel;
