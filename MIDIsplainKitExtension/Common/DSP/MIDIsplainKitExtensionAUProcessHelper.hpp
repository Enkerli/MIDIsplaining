//
//  MIDIsplainKitExtensionAUProcessHelper.hpp
...
#include <vector>
#include "MIDIsplainKitExtensionDSPKernel.hpp"

//MARK:- AUProcessHelper Utility Class
class AUProcessHelper
{
public:
    AUProcessHelper(MIDIsplainKitExtensionDSPKernel& kernel)
    : mKernel{kernel} {}
...
private:
    MIDIsplainKitExtensionDSPKernel& mKernel;
};
