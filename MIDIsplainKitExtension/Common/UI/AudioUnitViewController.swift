...
private let log = Logger(subsystem: "ca.iethnographer.MIDIsplainKitExtension", category: "AudioUnitViewController")

public class AudioUnitViewController: AUViewController, AUAudioUnitFactory {
    var audioUnit: AUAudioUnit?
    
    var hostingController: HostingController<MIDIsplainKitExtensionMainView>?
	...
	*/
    ...
    public func createAudioUnit(with componentDescription: AudioComponentDescription) throws -> AUAudioUnit {
        audioUnit = try MIDIsplainKitExtensionAudioUnit(componentDescription: componentDescription, options: [])
        
        guard let audioUnit = self.audioUnit as? MIDIsplainKitExtensionAudioUnit else {
            log.error("Unable to create MIDIsplainKitExtensionAudioUnit")
            return audioUnit!
        }
        ...
        audioUnit.setupParameterTree(MIDIsplainKitExtensionParameterSpecs.createAUParameterTree())
    ...
    private func configureSwiftUIView(audioUnit: AUAudioUnit) {
        ...
        let content = MIDIsplainKitExtensionMainView(parameterTree: observableParameterTree)
